      ...
      <div className="dd-panel">
        ...
        {loading ? (
          ...
          <div className="dd-content">
            {report.image_url && (
              <img src={report.image_url} alt={report.title} className="dd-img"
                onError={e => e.target.style.display="none"} />
            )}
            <div className="dd-body">
              <div className="dd-tags">
                <span className="dd-tag" style={{color:cat.color,background:`${cat.color}18`,border:`1px solid ${cat.color}33`}}>
                  {cat.icon} {cat.label}
                </span>
                <span className="dd-tag" style={{color:status.color,background:`${status.color}18`,border:`1px solid ${status.color}33`}}>
                  {status.label}
                </span>
                {report.pinned_to_map===1 && (
                  <span className="dd-tag" style={{color:"var(--teal)",background:"var(--teal-dim)",border:"1px solid rgba(0,201,167,.3)"}}>
                    📍 Map Pinned
                  </span>
                )}
              </div>
              ...
              <div className="dd-stats">
                ...
                <span>👥 {report.unique_upvoters||0}/5 unique</span>
              ...
              <div className="dd-author">
                ...
                <div>
                  ...
                  <div className="dd-author-sub">Reporter</div>
                </div>
              </div>
              ...
              <div className="dd-comments">
                ...
                <div className="dd-comment-row">
                  <input className="dd-comment-input" placeholder="Add a comment…"
                    value={comment} onChange={e => setComment(e.target.value)}
                    onKeyDown={e => e.key==="Enter" && postComment()} maxLength={500} />
                ...
                <div className="dd-comment-list">
                  {(report.comments||[]).length===0
                    ? <p className="dd-no-comments">No comments yet</p>
